...
export const Adventages = () => {
    ...
    return (
        <div ref={ref} className='gradient h-[150vh] w-full relative z-20 mb-[100vh] border-b border-gray-300 rounded-b-3xl'>
...
const Adventage = ({image, heading, text, marginFirst, marginLast}) => {
    ...
    return (
        <motion.div className='bg-[#E8D7BD] rounded-3xl overflow-hidden even:z-10 shadow-lg shadow-gray-300 border border-gray-400 w-full ' style={{marginLeft: marginValue}}>
