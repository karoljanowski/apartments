...
export const Adventages = () => {
    ...
    return (
        <div ref={ref} className='gradient h-[300vh] lg:h-[150vh] w-full relative z-20 mb-[200vh] lg:mb-[100vh] border-b border-gray-300 rounded-b-3xl'>
...
const Adventage = ({image, heading, text, marginFirst, marginLast, top}) => {
    const mediaMatch = useMediaQuery('(min-width: 992px)');

    const marginValue = marginFirst ? marginFirst : marginLast
    return (
        <motion.div className='bg-[#E8D7BD] h-[80vh] lg:h-auto rounded-3xl overflow-hidden lg:even:z-10 shadow-lg shadow-gray-300 border border-gray-400 w-full absolute lg:static left-0' style={{marginLeft: mediaMatch ? marginValue : 0, top: !mediaMatch ? top : 0}}>
            ...
            <div className='lg:mt-2 lg:mb-6 p-4 lg:p-6 text-center flex flex-col h-full'>
